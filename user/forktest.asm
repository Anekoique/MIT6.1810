...
forktest(void)
{
  ...
  34:	3f850513          	addi	a0,a0,1016 # 428 <munmap+0xe>
  ...
  56:	42650513          	addi	a0,a0,1062 # 478 <munmap+0x5e>
  ...
  6c:	3d050513          	addi	a0,a0,976 # 438 <munmap+0x1e>
  ...
  7e:	3d650513          	addi	a0,a0,982 # 450 <munmap+0x36>
  ...
  ae:	3be50513          	addi	a0,a0,958 # 468 <munmap+0x4e>
